...
export const VLT_TABLE_LABEL = {
    ...
    [KEY_NAME["EV/EBITDA"]]: {
        [VLT_MODELS.PRICE]: {
            label: [KEY_NAME["EV/EBITDA"], KEY_NAME.SALES, KEY_NAME.EPM, KEY_NAME.EBITDA, KEY_NAME.EV, KEY_NAME.DBT_I, KEY_NAME.MV, KEY_NAME.SHARE_NUM, OTHER_KEY_NAME.PRICE],
            editable: [KEY_NAME["EV/EBITDA"], KEY_NAME.SALES, KEY_NAME.EPM, KEY_NAME.DBT_I, KEY_NAME.SHARE_NUM]
        }
    },
}