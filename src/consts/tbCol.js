...
export const VLT_TABLE_LABEL = {
    [KEY_NAME.PER]: {
        ...
        [VLT_MODELS.PRFM]: {
            label: [KEY_NAME.PER, OTHER_KEY_NAME.PRICE, KEY_NAME.EPS, KEY_NAME.SHARE_NUM, KEY_NAME.MV, KEY_NAME.NP_CTRL, KEY_NAME.NPM, KEY_NAME.SALES],
            editable: [KEY_NAME.PER, OTHER_KEY_NAME.PRICE, KEY_NAME.NPM]
        },
        [VLT_MODELS.MLTP]: {
    ...
    [KEY_NAME.POR]: {
        ...
        [VLT_MODELS.PRFM]: {
            label: [KEY_NAME.POR, OTHER_KEY_NAME.PRICE, OTHER_KEY_NAME.OPS, KEY_NAME.SHARE_NUM, KEY_NAME.MV, KEY_NAME.OP, KEY_NAME.OPM, KEY_NAME.SALES],
            editable: [KEY_NAME.POR, OTHER_KEY_NAME.PRICE, KEY_NAME.OPM]
        },
        [VLT_MODELS.MLTP]: {
            label: [OTHER_KEY_NAME.PRICE, KEY_NAME.SALES, KEY_NAME.OPM, KEY_NAME.OP, KEY_NAME.SHARE_NUM, KEY_NAME.MV, OTHER_KEY_NAME.OPS, KEY_NAME.POR],
            editable: [OTHER_KEY_NAME.PRICE, KEY_NAME.SALES, KEY_NAME.OPM]
        },
    },
    [KEY_NAME.PSR]: {
        [VLT_MODELS.PRICE]: {
        ...
        [VLT_MODELS.PRFM]: {
            label: [KEY_NAME.PSR, OTHER_KEY_NAME.PRICE, OTHER_KEY_NAME.SPS, KEY_NAME.SHARE_NUM, KEY_NAME.MV, KEY_NAME.SALES],
            editable: [KEY_NAME.PSR, OTHER_KEY_NAME.PRICE]
        },
        [VLT_MODELS.MLTP]: {
            label: [OTHER_KEY_NAME.PRICE, KEY_NAME.SALES, KEY_NAME.SHARE_NUM, KEY_NAME.MV, OTHER_KEY_NAME.SPS, KEY_NAME.PSR],
            editable: [OTHER_KEY_NAME.PRICE, KEY_NAME.SALES]
        },
    },
    [KEY_NAME.PBR]: {
        [VLT_MODELS.PRICE]: {
        ...
        [VLT_MODELS.PRFM]: {
            label: [KEY_NAME.PBR, OTHER_KEY_NAME.PRICE, KEY_NAME.BPS, KEY_NAME.SHARE_NUM, KEY_NAME.MV, KEY_NAME.ASST_CTRL],
            editable: [KEY_NAME.PBR, OTHER_KEY_NAME.PRICE]
        },
        [VLT_MODELS.MLTP]: {
            label: [OTHER_KEY_NAME.PRICE, KEY_NAME.ASST_CTRL, KEY_NAME.SHARE_NUM, KEY_NAME.MV, KEY_NAME.BPS, KEY_NAME.PBR],
            editable: [OTHER_KEY_NAME.PRICE, KEY_NAME.ASST_CTRL]
        },
    },
}